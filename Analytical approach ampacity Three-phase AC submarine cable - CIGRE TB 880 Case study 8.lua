...
-- Calculation of Armour losses  - CIGRE TB 880 GP23 and GP32
...
function calculate_current_rating()
  ...
  repeat
    ...
    print(format("Iter %d | Dphi=%.3f °C, W_d=%.6f W/m, T1=%.6f, T2=%.6f, T3=%.6f, T4=%.6f, R=%.8f Ohm/m, n=%d, lamba1=%.6f, lamba2=%.6f | I=%.3f A | sheath=%.3f °C,armour=%.3f °C ", iter, delta_theta, W_d, T1, T2, T3, T4, R_ac, n, lambda_1, lambda_2, new_I, sheath_temp, armour_temp))
